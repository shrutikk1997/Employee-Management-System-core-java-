...
public class AdminEditFrame extends Frame implements ActionListener
{
   ...
   Button btsubmit,btreset;
		    ...
		    public AdminEditFrame(Employee e1)
		    {
	...
	public void actionPerformed(ActionEvent a) {
		...
		else if(a.getSource()==btsubmit)
		{
			...
			{
				JOptionPane.showMessageDialog(this, "admin edited successfully");
				this.dispose();
				new EmployeesFrame();
			}
			else
